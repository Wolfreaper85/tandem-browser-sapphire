...
function renderAboutPanel() {
  ...
  content.innerHTML = `
    <div class="about-panel-wrapper">
      ...
      <div class="about-subtitle">AI Companion Browser</div>
      <div class="about-quote" style="color:#a78bfa;">Sapphire Edition</div>
      <div class="about-version">v0.62.17-sapphire</div>
      <div class="about-info">
        Originally built for human-AI collaboration with OpenClaw.<br>
        Modified to integrate with <strong style="color:#a78bfa;">Sapphire AI</strong> — providing seamless browsing,<br>
        Wingman chat bridge, and AI-driven web tools.
      </div>
      <div class="about-link-wrapper">
        <a href="https://github.com/hydro13" class="about-link" id="about-github-link">GitHub — hydro13 (Original Creator)</a>
        <a href="https://github.com/Wolfreaper85" class="about-link" id="about-github-wolf">GitHub — Wolfreaper85</a>
      </div>
      <div class="about-copyright">&copy; 2026 Robin Waslander &mdash; Original Tandem Browser</div>
      <div class="about-team">Sapphire integration by Wolf &amp; Claude</div>
    </div>
  `;
  ...
  const wolfLink = document.getElementById('about-github-wolf');
  if (wolfLink) {
    wolfLink.addEventListener('click', (e) => {
      e.preventDefault();
      if (window.tandem) window.tandem.newTab('https://github.com/Wolfreaper85');
    });
  }
}
